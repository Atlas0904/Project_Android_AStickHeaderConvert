package com.example.atlas_huang.astickheaderconvert;
...
import com.example.atlas_huang.astickyheader.R;
...
public class GridActivity extends CacheActivity {
    ...
    private Integer[] mHeaderPositions = { 0, 12, 11, 37, 38, 60, 77, 89 };
